...
<div class="form-row" >
  <div class="form-group col-md-6">
    ...
    <input type="text" name="flight_name" class="form-control" id="inputFirstName"  value="'.$flight_name.'">
  </div>
  <div class="form-group col-md-6">
    <label for="inputLastName">FLIGHT ID</label>
    <input type="text" name="flight_id" class="form-control" id="inputFirstName"  value="'.$flight_id.'">
   
  </div>
</div>
<div class="form-group">
  <label for="inputAddress">FLIGHT TYPE</label>
  <input type="text" name="flight_type"class="form-control" id="inputAddress" value="'.$flight_type.'">
</div>
<div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputCity">FROM</label>
      <input type="text"name="departure" class="form-control" id="inputCity" value="'.$from.'">
    </div>
    <div class="form-group col-md-4">
      <label for="inputState">TO</label>
      <input name="destination" id="inputState"  class="form-control" value="'.$to.'">
        
    </div>
    <div class="form-group col-md-2">
      <label for="inputZip">DEPARTTURE DATE</label>
      <input type="text" name="dep_date" class="form-control" id="inputdd" value="'.$dep_date.'" >
    </div>
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputCity">DEPARTTURE TIME</label>
      <input type="text" name="dep_time" class="form-control" id="inputdt"value="'.$dep_time.'">
    </div>
    <div class="form-group col-md-2">
      <label for="inputZip">ARRIVAL DATE</label>
      <input type="text" name="arr_date" class="form-control" id="inputad" value="'.$arr_date.'">
    </div>
    <div class="form-group col-md-2">
      <label for="inputZip">ARRIVAL TIME</label>
      <input type="text" name="arr_time" class="form-control" id="inputat" value="'.$arr_time.'">
    </div>
    <div class="form-group col-md-2">
      <label for="inputZip">No of eats</label>
      <input type="text" name="no_of_seats" class="form-control" id="inputat" value="'.$arr_time.'">
    </div>
