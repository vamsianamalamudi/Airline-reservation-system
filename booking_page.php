...
<head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="panda.css" />
...
<form action="done.php" method="POST">
  <div class="form-row" >
    <div class="form-group col-md-6">
      ...
      <input type="text" name="First Name" class="form-control" id="inputFirstName" placeholder="Enter First Name">
    </div>
    <div class="form-group col-md-6">
