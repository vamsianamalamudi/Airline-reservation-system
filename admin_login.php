...
<form action="admin_login_check.php" method = "post" >
  ...
  <br>
    ...
    <input type="text" placeholder="Enter Admin Email id" name="adminusername" required><br>
   ...
   <button class="w3-button w3-black w3-center w3-section w3-right" type="submit" value="Submit">LOG IN</button>
</div>
